...
function show(){
  document.getElementById("body").innerHTML += "<div class='d-block d-lg-none' style='height: 100%; width: 100%; position: fixed; z-index: 10000; background:#000; color:#fff;' id='sv'><center><div class='hy'><img src='img/logo.png' style='margin:10%; border-radius:50%; height:100px; weight:100px;'><ul class='navbar-nav me-auto mb-2 mb-lg-0' class='navbar-nav me-auto mb-2 mb-lg-0'><li class='nav-item active'><a class='nav-link link-light' id='cl' href='#Whitepaper'>Whitepaper</a></li><li class='nav-item'><a class='nav-link link-light' id='cl' href='#Etherscan'>Etherscan</a></li><li class='nav-item'><a class='nav-link link-light' id='cl' href='#Team'>Team</a></li><li class='nav-item'><a class='nav-link link-light' id='cl' href='#Roadmap'>Roadmap</a></li></ul><ul class='me-auto mb-2 mb-lg-0 bd'><li class='cb'><a class='link-light' href='https://twitter.com/willofmyanmar'>Twitter</a></li><a style='font-size: 30px;'>|</a><li class='cb'><a class='link-light' href='https://t.me/will_of_myanmar'>Telegram</a></li><li class='nav-item'><a class='nav-link link-light' role='button' id='cl'>Close</a></li></ul></center></div></div>";
    $("#cl").each(function(mnm){$(this).on("click", function(){cl();}});
}
